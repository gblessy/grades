...
// @access  Public
router.get("/test", (req, res) => res.json({ msg: "Emails Works" }));
...
router.get("/", (req, res) => {
  const msg = {
    to: "radv7vam@gmail.com",
    from: "superschool@test.com",
    subject: "Grade notification",
    text:
      "Your son got 4 on Math class. Please read School Book 1 pg. 54. And do excercies 34, 35 and 45"
  };
  sgMail
    .send(msg)
